...
wedstrijd_1_scoren_land_1 = int(input(f"wat is de scoren van: {land_1_naam}:"))
wedstrijd_1_scoren_land_2 = int(input(f"wat is de scoren van: {land_2_naam}:"))
...
land_1_doelsaldo_punten_w1 = 0
land_2_doelsaldo_punten_w1 = 0
land_3_doelsaldo_punten_w1 = 0

if winaar_wedstrijd_1 == wedstrijd_1_scoren_land_1:
    land_1_doelsaldo_punten_w1 = doelsaldo_winaar_1

if doelsaldo_winaar_1 == land_1_doelsaldo_punten_w1:
    land_2_doelsaldo_punten_w1 = doelsaldo_loser_1

if winaar_wedstrijd_1 == wedstrijd_1_scoren_land_2:
    land_2_doelsaldo_punten_w1 = doelsaldo_winaar_1

if doelsaldo_winaar_1 == land_2_doelsaldo_punten_w1:
    land_1_doelsaldo_punten_w1 = doelsaldo_loser_1
print("-------------------------------------------------------------------")
...
print(f"{land_1_naam}: punten: {wedstrijd_1_scoren_land_1} doelsaldo: {land_1_doelsaldo_punten_w1}")
print(f"{land_2_naam}: punten: {wedstrijd_1_scoren_land_2} doelsaldo: {land_2_doelsaldo_punten_w1}")
print(f"{land_3_naam}: punten: {wedstrijd_1_scoren_land_3} doelsaldo: {land_3_doelsaldo_punten_w1}")
print("-------------------------------------------------------------------")
...
wedstrijd_2_scoren_land_2 = int(input(f"wat is de scoren van: {land_2_naam}:"))
wedstrijd_2_scoren_land_3 = int(input(f"wat is de scoren van: {land_3_naam}:"))
...
wedstrijd_3_scoren_land_1 = int(input(f"wat is de scoren van: {land_1_naam}:"))
wedstrijd_3_scoren_land_3 = int(input(f"wat is de scoren van: {land_3_naam}:"))
...
totaal_punten_land_1 = wedstrijd_1_scoren_land_1 + wedstrijd_3_scoren_land_1
totaal_punten_land_2 = wedstrijd_1_scoren_land_2 + wedstrijd_2_scoren_land_2
totaal_punten_land_3 = wedstrijd_2_scoren_land_3 + wedstrijd_3_scoren_land_3

totaal_doelsaldo_land_1 = land_1_doelsaldo_punten_w1 + land_1_doelsaldo_punten_w3
totaal_doelsaldo_land_2 = land_2_doelsaldo_punten_w1 + land_2_doelsaldo_punten_w2
totaal_doelsaldo_land_3 = land_3_doelsaldo_punten_w2 + land_3_doelsaldo_punten_w3

if totaal_doelsaldo_land_1 > totaal_doelsaldo_land_2 and totaal_doelsaldo_land_3:
    gewonnen = (f"{land_1_naam} heeft gewonnen met een scoren van: {totaal_doelsaldo_land_1}")

if totaal_doelsaldo_land_2 > totaal_doelsaldo_land_1 and totaal_doelsaldo_land_3:
    gewonnen = (f"{land_2_naam} heeft gewonnen met een scoren van: {totaal_doelsaldo_land_2}")
    
if totaal_doelsaldo_land_3 > totaal_doelsaldo_land_1 and totaal_doelsaldo_land_2:
    gewonnen = (f"{land_3_naam} heeft gewonnen met een scoren van: {totaal_doelsaldo_land_3}")
